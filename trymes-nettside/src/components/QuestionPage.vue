...
export default {
  ...
  data() {
    return {
      quizItems: [
        { id: "1", question: "Hvor god er du i styrke?" },
        { id: "2", question: "Hvor god er du i balanse?" },
        {
          id: "3",
          question: "Hvor god hurtighet har du?(Hvor raskt kan du løpe?)",
        },
        {
          id: "4",
          question: "Hvor god utholdenhet har du?(Kan du løpe/gå lenge?",
        },
        {
          id: "5",
          question:
            "Er du god i orientering?(Lese kart og løpe til riktige avmerkede punkter)",
        },
      ],
    };
  },
